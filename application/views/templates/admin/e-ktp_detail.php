        ...
        <div class="container-fluid px-4">
            ...
            <div class="row container ">
                ...
                <?php } elseif ($detail['status'] == 1) { ?>
                    ...
                    <label for="" class="mt-3">Kode : </label>
                    <h1><?= $detail['kode'] ?></h1>

                <?php } ?>
                <?php if ($detail['status'] == '1' || '0') { ?>
                ...
                <div action="#">
                    ...
                    <input name="nama" class="form-control mt-2" id="inputFirstName" type="text" placeholder="Masukkan nama " id="nama" value=" <?= $detail['nama'] ?> " readonly>
                    <label for="" class="mt-3">NIK</label>
                    <input name="nik" class="form-control mt-2" id="inputFirstName" type="text" placeholder="Masukkan NIK" value=" <?= $detail['nik'] ?> " readonly>
                    ...
                    <?php if ($detail['file7'] == null) { ?>
                        <input name="nik" class="form-control mt-2" id="inputFirstName" type="text" placeholder="Masukkan NIK" readonly>
                    <?php } else { ?>
                    ...
                    <?php if ($detail['status'] == 2) { ?>
                        <form action=" <?= base_url('admin/persetujuan_ektp/' . $detail['id']) ?> " method="post">
                            <label class="mt-3" for=""> Catatan </label>
                            <textarea class="form-control mt-2 mb-3" name="catatan" id="" cols="30" rows="10" required></textarea>
                            <div class="row">
                                <div class="col-md-6 d-grid">
                                    <input type="submit" class="btn btn-success btn-block" value="Terima" name="submit_action">
                                </div>
                                <div class="col-md-6 d-grid">
                                    <input type="submit" class="btn btn-danger btn-block" value="Tolak" name="submit_action">
                                </div>
                            </div>
                    ...
                    <div class="mt-4 mb-3">
                        <div class="d-grid">
                            <a href=" <?= base_url('admin/ektp_status') ?> " class="btn btn-primary btn-block" type="submit">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
