    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="row container ">
                <form action="" class="row col-md-8 card">
                    <label for="" class="mt-3">Nama</label>
                    <input name="nama" class="form-control mt-2" id="inputFirstName" type="text" placeholder="Enter your first name">
                    <label for="" class="mt-3">NIK</label>
                    <input name="nik" class="form-control mt-2" id="inputFirstName" type="text" placeholder="Enter your first name">
                    <label for="" class="mt-3">Surat Pengantar RT/RW</label>
                    <input name="ektp_file1" class="form-control mt-2" id="inputFirstName" type="file" placeholder="Enter your first name">
                    <label for="" class="mt-3">Fotocopy Kartu Keluarga</label>
                    <input name="ektp_file2" class="form-control mt-2" id="inputFirstName" type="file" placeholder="Enter your first name">
                    ...
                    <input name="ektp_file3" class="form-control mt-2" id="inputFirstName" type="file" placeholder="Enter your first name">
                    ...
                    <input name="ektp_file4" class="form-control mt-2" id="inputFirstName" type="file" placeholder="Enter your first name">
                    <label for="" class="mt-3">Surat keterangan lahir dari bidan dan desa / kelurahan</label>
                    <input name="ektp_file5" class="form-control mt-2" id="inputFirstName" type="file" placeholder="Enter your first name">
                    <label for="" class="mt-3">Surat keterangan pindah yang diterbitkan oleh pemerintah kabupaten / Kota dari daerah asal</label>
                    <input name="ektp_file6" class="form-control mt-2" id="inputFirstName" type="file" placeholder="Enter your first name">
                    ...
                    <input name="ektp_file7" class="form-control mt-2" id="inputFirstName" type="file" placeholder="Enter your first name">
                    ...
                    <input name="ektp_file8" class="form-control mt-2" id="inputFirstName" type="file" placeholder="Enter your first name">
                    <div class="mt-4 mb-3">
                        <div class="d-grid"><a class="btn btn-primary btn-block" type="submit">Ajukan</a></div>
                    </div>
                </form>
            </div>
